...
const Header2 = () => {
    ...
    return (
        <div className='relative w-screen h-screen overflow-hidden'>
            ...
            {/* <div className="absolute w-full h-full bg-cover bg-center p-10" style={{ backgroundImage: `url(/Group bg-tripfy.jpg)` }}> */}
                ...
                {isNavOpen && (
                    <div className="absolute top-0 right-0 w-64 h-full bg-transparent backdrop-blur-lg shadow-lg z-40 flex flex-col items-start p-4">
                        ...
                        <nav className="flex flex-col space-y-2">
                            ...
                            <a onClick={() => navigate('/corporate-travelpage')} className="text-gray-400 cursor-pointer">Corporate travel</a>
