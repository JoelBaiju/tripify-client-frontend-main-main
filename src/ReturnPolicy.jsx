    ...
    return (
        ...
        >
            ...
            <div className="h-fit w-full bg-gradient-to-r from-blue-500 via-blue-400 to-blue-900 ">
                <img src="/view-3d-practicing-lawyer.png" alt="" className="md:w-3/12 md:ml-32" />
                ...
                <motion.h2
                    ...
                    >
                        ReFund Policy - QatayWorld Pvt Ltd.
                    </motion.h2>
                </div>
             </div>
            <div
            ...
            >
                ...
                <section>
                    ...
                    <p>If your refund is approved, then your refund will be processed in 15 days, and a credit will automatically be applied to your credit card or original method of payment, within 7 working days.</p>
                </section>
